...
exports.forgotPassword = catchAsyncErrors(async (req, res, next) => {
  const user = await User.findOne({ email: req.body.email }); //user => User
...
//Resete password =>  /api/v1/password/reset/:token
...
///  get the currently logged in user details   =>      /api/v1/me
